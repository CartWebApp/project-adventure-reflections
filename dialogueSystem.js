...
let dialogue0 = [{dialogue: "“---Kagami!”", type: "text", location: "hallways"}, {dialogue:"I scan through the sea of uniforms until I see her heading my way. She slows down, panting lightly, and puts her hand on her knees to catch her breath before standing back up with a bright smile."}, {dialogue: "“Good morning… you walk fast, don’t you know that?”", type: "text", person: "sadie", emotion: "happy", location: "hallways"}, {dialogue: "“Oh, sorry! I just don’t want to be late for class.” I say, slightly embarrassed.", type: "internal-text", location: "hallways"}, {dialogue: "“I get it, I’m the same way. I’m always rushing to get to class on time.” She says with a chuckle.", type: "text", person: "sadie", emotion: "happy", location: "hallways"}, {dialogue: "We walk together for a bit before we reach our classroom. We say our goodbyes and head to our respective classes.", type: "internal-text", location: "hallways"}];


let dialogue1 = [{ dialogue: "Hello!", emotion: "happy", type: "text", person: "Sadie", location: "club" }, { dialogue: "Sad Hello", emotion: "sad", type: "text", person: "Sadie", location: "room" }, { dialogue: "You see a trash can, sitting innocently in the corner, potentially hiding the secrets of the universe within its maw. It almost seems to taunt you.", type: "internal-text" }, { dialogue: "Check inside the trash can?", type: "choice", choices: ["HELL YEAH", "No, wtf are you on about??", "Third Test Choice"], results: [{ text: "You give into your urges; the <b>animalistic</b> desire to know what <em>exactly</em> was in that trash can...only to find nothing.", choice: "checkedTrashCan", value: 1 }, { text: "You didnt check the trash can...Good job", choice: "checkedTrashCan", value: 0 }]}];
