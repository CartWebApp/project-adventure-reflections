        ...
        text[0].choices.forEach(choice => {
            ...
            button.onclick = function () {
                ...
                if (this.value == 0) {
                    ...
                    dialouge = dialouge.concat([{ dialouge: "Hello!", emotion: "happy", type: "text" }, { dialouge: "You checked the trash can, didn't you?", emotion: "happy", type: "text" }, { dialouge: "Wow...you are weird, you know that?", emotion: "happy", type: "text" }]);
